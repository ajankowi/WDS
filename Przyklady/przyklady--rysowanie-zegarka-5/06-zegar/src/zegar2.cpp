...
/*==============================================================================
 * Przyklad demonstruje mozliwosc tworzenia lokalizacji narodowych i ich zmian.
 * Pokazane jest wplyw lokalizacji na format wyswietlanej daty.
 *
 * Dodatkowo aplikacja demonstruje wykorzystanie obiektu klasy QTimer oraz
 * transformacji ukladu wspolrzednych przy rysowaniu na obiekcie klasy QWidget.
 * Rysowana jest podzialka minutowa i godzinna oraz oznaczenia godzin. Napisy sa
 * rozlozone wewnatrz cyferblatu i prawidlowo obrocone w sposob czytelny dla
 * uzytkownika. Ponadto rysowane sa wskazowki zegara. 
...
void Zegar::GdySekunda()
{
  ...
  //
  //  Tu mozna zmieniac i wyprobowac inne lokalizacje
  //
  //QLocale  Lokalizacja(QLocale::French,QLocale::Canada);
  //QLocale  Lokalizacja(QLocale::Chinese);
