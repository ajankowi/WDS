/****************************************************************************
** Meta object code from reading C++ file 'Kanwa.hh'
**
...
#include "../../inc/Kanwa.hh"
#include <QtCore/qbytearray.h>
#include <QtCore/qmetatype.h>
#if !defined(Q_MOC_OUTPUT_REVISION)
#error "The header file 'Kanwa.hh' doesn't include <QObject>."
...
QT_MOC_LITERAL(1, 6, 15), // "ZglosZamkniecie"
QT_MOC_LITERAL(2, 22, 0), // ""
QT_MOC_LITERAL(3, 23, 13) // "GdyZamkniecie"

    },
    "Kanwa\0ZglosZamkniecie\0\0GdyZamkniecie"
};
...
void Kanwa::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->ZglosZamkniecie(); break;
        case 1: _t->GdyZamkniecie(); break;
        default: ;
        }
        ...
        {
            using _t = void (Kanwa::*)();
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&Kanwa::ZglosZamkniecie)) {
                *result = 0;
                return;
            }
        }
